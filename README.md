...
- 🎯 Entry points to execute your program using `python -m <sanit>` or `$ sanit` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/engrogerio/sanit/branch/main/graph/badge.svg?token=sanit_token_here)](https://codecov.io/gh/engrogerio/sanit)
[![CI](https://github.com/engrogerio/sanit/actions/workflows/main.yml/badge.svg)](https://github.com/engrogerio/sanit/actions/workflows/main.yml)

Awesome sanit created by engrogerio

## Install

from source
```bash
git clone https://github.com/engrogerio/sanit sanit
cd sanit
make install
```
...
```bash
❯ sanit --help
Usage: sanit [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ sanit create-user --help
Usage: sanit create-user [OPTIONS] USERNAME PASSWORD
...
```bash
sanit create-user admin admin --superuser
```
...
Run with `sanit run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `sanit create-user`.
...
-----------------------------------------------------
sanit/__init__.py              4      0   100%
sanit/app.py                  16      1    94%
sanit/cli.py                  21      0   100%
sanit/config.py                5      0   100%
sanit/db.py                   10      0   100%
sanit/models/__init__.py       0      0   100%
sanit/models/content.py       47      1    98%
sanit/routes/__init__.py      11      0   100%
sanit/routes/content.py       52     25    52%
sanit/routes/security.py      15      1    93%
sanit/routes/user.py          52     26    50%
sanit/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in sanit/default.toml.
